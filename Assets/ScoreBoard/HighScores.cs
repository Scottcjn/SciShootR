...
{
    const string privateCode = "bA4a8huIkEehODtWLXnwxAggKv33gPXkqhkgsx5pUuAg";  //Key to Upload New Info
    const string publicCode = "61f1a9398f40bb124408d29e";   //Key to download
